...
plt.figure(1)
plt.plot(t,data_1p_Forward_Euler_z[1:],label="Forward Euler")
plt.plot(t,data_1p_RK4_z[1:],label="Runge Kutta 4")
...
def error_plot(num_time_steps, method):
    ...
    jump = 1#int(num_time_steps/1000)
    plt.plot( t[::jump], error[::jump],".", markersize = 1,label=f"n_step ={num_time_steps}")
